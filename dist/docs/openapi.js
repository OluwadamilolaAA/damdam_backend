    ...
    paths: {
        ...
        "/api/auth/google/callback": {
            get: {
                ...
                description: "On success, sets refresh cookie and redirects to frontend success URL. On failure, redirects to failure URL.",
                responses: {
                    "302": {
        ...
        "/api/products": {
            get: {
                ...
                description: "Supports multi-category filtering, price range, keyword search, sorting, and paginated metadata.",
                parameters: [
                    {
                        name: "category",
                        in: "query",
